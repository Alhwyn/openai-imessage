---
name: connected-apps
description: Use Composio for the person's Gmail and other connected accounts. For personal context, search their Gmail. Use Calendar for their schedule. Use when they ask about email, calendar, or similar account APIs — never for browser/desktop GUI work.
---
...
- Answer ordinary questions and general knowledge directly. Do not use Composio for that.
...
- If a Calendar tool returns no meetings or an empty window, do not mention that result. Never paste raw Calendar empty-state text into chat.
