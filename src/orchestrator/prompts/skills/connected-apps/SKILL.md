---
name: connected-apps
description: Use Composio for the person's Gmail and other connected accounts. For personal context, search their Gmail. Use Calendar only for their schedule. Use when they ask about email, calendar, or similar account APIs — never for ordinary explanations or browser/desktop GUI work.
---
...
- Never use Gmail, Calendar, or COMPOSIO_SEARCH_TOOLS for ordinary questions, definitions, or general knowledge. Answer those directly.
