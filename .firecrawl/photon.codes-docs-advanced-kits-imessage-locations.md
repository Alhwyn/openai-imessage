...
[Skip to main content](https://photon.codes/docs/advanced-kits/imessage/locations#content-area)
...
Location updates are not part of the durable event log. `im.locations.watch(...)` is a dedicated live stream. Updates missed while disconnected cannot be replayed with [`im.events.catchUp(...)`](https://photon.codes/docs/advanced-kits/imessage/events).

## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#what-you-can-do)  What You Can Do
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#before-you-use-it)  Before You Use It
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#request-location-sharing)  Request Location Sharing
...
When `messageGuid` is present, use it like any other message GUID. For example, you can look it up with [`im.messages.get(...)`](https://photon.codes/docs/advanced-kits/imessage/messages).For idempotent retries from your job system, pass `clientMessageId`:
...
`clientMessageId` is only needed when your queue or worker may rerun the same logical request after a crash or timeout. Most direct calls can omit it. See [error handling](https://photon.codes/docs/advanced-kits/imessage/error-handling) for details.

After the other person accepts or starts sharing, use `get(...)`, `list(...)`, or `watch(...)` to read their location.

## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#list-shared-locations)  List Shared Locations
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#get-one-friend-location)  Get One Friend Location
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#location-types)  Location Types
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#watch-live-updates)  Watch Live Updates

### [​](https://photon.codes/docs/advanced-kits/imessage/locations\#scope)  Scope
...
### [​](https://photon.codes/docs/advanced-kits/imessage/locations\#update-shape)  Update Shape
...
## [​](https://photon.codes/docs/advanced-kits/imessage/locations\#next-steps)  Next Steps

1. [Addresses](https://photon.codes/docs/advanced-kits/imessage/addresses) — check whether an email address or phone number is reachable over iMessage
2. [Events](https://photon.codes/docs/advanced-kits/imessage/events) — understand durable events and catch-up
3. [Chats](https://photon.codes/docs/advanced-kits/imessage/chats) — manage chats, read state, and typing state
...
[Addresses\\
\\
Previous](https://photon.codes/docs/advanced-kits/imessage/addresses) [Events\\
\\
Next](https://photon.codes/docs/advanced-kits/imessage/events)
