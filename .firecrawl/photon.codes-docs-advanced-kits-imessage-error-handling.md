...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#what-you-can-do)  What You Can Do
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#handle-errors)  Handle Errors
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#error-object)  Error Object
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#common-error-codes)  Common Error Codes
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#grpc-status-mapping)  gRPC Status Mapping
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#retries)  Retries
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#idempotency)  Idempotency
...
## [​](https://photon.codes/docs/advanced-kits/imessage/error-handling\#next-steps)  Next Steps

1. [Events](https://photon.codes/docs/advanced-kits/imessage/events) — recover after stream disconnects
2. [Messages](https://photon.codes/docs/advanced-kits/imessage/messages) — understand write methods, idempotency keys, and message errors
3. [Attachments](https://photon.codes/docs/advanced-kits/imessage/attachments) — handle `attachmentNotReady`
